...
func addPaddedLeftView(textField: UITextField, image: UIImage, imageH: UIImage) {
...
func addSecureTextSwitcher(textField: UITextField, image: UIImage, imageSel: UIImage,width:CGFloat) -> UIButton {
...
func addButtonCorner_OK(btn:UIButton){
    ...
    btn.setBackgroundImage(UIImage.imageWithColor(UIColor.colorWithHex("#2495DD")), forState: UIControlState.Normal)
    btn.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
